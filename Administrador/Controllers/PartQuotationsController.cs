...
namespace Administrador.Controllers
{
    ...
    public class PartQuotationsController : ControllerBase
    {
        ...
        public PartQuotationsController(AdministradorDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<PartQuotation>> PostPartQuotation(PartQuotation partQuotation)
        {
          if (_context.PartQuotations == null)
          {
              return Problem("Entity set 'AdministradorDbContext.PartQuotations'  is null.");
          }
            ...
            {
                if (PartQuotationExists(partQuotation.Id))
                {
                    return Conflict();
                }
                else
